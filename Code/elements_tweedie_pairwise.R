# Tweedie GLM for elements Analysis with Pairwise comparisons
...
save(fit3, file = "../Data/Elements Tweedie Model_NO_A.rda")
...
save(fit3, file = "../Data/Elements Tweedie Model_NO_N.rda")
...
save(fit3, file = "../Data/Elements Tweedie Model_NO_L.rda")
